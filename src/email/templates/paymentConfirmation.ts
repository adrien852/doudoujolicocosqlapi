...
function getEmailBody(data){
    ...
    return {
        body: {
            ...
            // },
            outro: [
                'Vous pouvez me contacter par email pour connaitre l\'avancé de la préparation et expédition de votre commande à l\'adresse suivante : contact@doudoujoli.fr',
